...
/**
 * @brief  Returns a reference to the input point.
 *
 * @param mp Pointer to the map.
 *
 * @return Returns the pointer to the input map.
 **/
Point * map_getInput(const Map *mp);

/**
 * @brief  Returns a reference to the output point.
 *
 * @param mp Pointer to the map.
 *
 * @return Returns the pointer to the output map.
 **/
...
/**
 * @brief  Set the reference to the input point.
 *
 * @param mp Pointer to the map.
 * @param p Pointer to the input point.
 *
 * @return Returns OK if the pointer exists, ERROR otherwise.
 **/
Status map_setInput(Map *mp, Point *p);

/**
 * @brief  Set the reference to the output point.
 *
 * @param mp Pointer to the map.
 * @param p Pointer to the output point.
 *
 * @return Returns OK if the pointer exists, ERROR otherwise.
 **/
...
/**
 * @brief: Makes a search from the origin point to the output point
 * of a map using the breadth-first search algorithm and the ADT Queue
 *
 * The function prints each visited point while traversing the map
 *
 * @param pf, File descriptor 
